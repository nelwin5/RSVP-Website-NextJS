    ...
    <div className="container mx-auto p-4 lg:p-6 rounded-3xl shadow-[0_1px_5px_rgba(0,0,0,0.2)]">
      <div className="flex flex-wrap gap-4 items-stretch min-h-full h-full">
        ...
        <div className="flex w-1/2 flex-wrap gap-4 flex-1">
          ...
          <div className="flex w-full gap-4">
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index + 1} className="w-1/3">
                <div className="flex h-[170px] w-full rounded-lg bg-gray-300 items-center justify-center relative">
                  {images[index + 1] ? (
          ...
          <div className="flex w-full gap-4">
            <div className="w-1/2">
              <div className="flex h-[190px] w-full rounded-lg bg-gray-300 items-center justify-center relative">
                {images[4] ? (
        ...
        <div className="flex w-1/2 flex-wrap gap-4 flex-1">
          <div className="w-full">
            <div className="flex h-[220px] w-full rounded-lg bg-gray-300 items-center justify-center relative">
              {images[6] ? (
          ...
          <div className="w-full">
            <div className="flex h-[250px] w-full rounded-lg bg-gray-300 items-center justify-center relative">
              {images[9] ? (
